...
while True:
    try:
        ...
        # abre o aarquivo
        with open(fr"C:\Users\ead\Documents\Andreprograma\logicaprogramacaoaulas\aula05\{novo_arquivo}.txt","w",encoding="utf-8") as f:
        ...
        novo_texto_add = input ("Digite um novo texto \n ")
        
        with open (fr"C:\Users\ead\Documents\Andreprograma\logicaprogramacaoaulas\aula05\{novo_arquivo}.txt","a",encoding="utf-8") as f:
            f.write(f"\n {novo_texto_add}")
